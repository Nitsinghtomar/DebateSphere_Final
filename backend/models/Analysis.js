// models/Analysis.js
// Cosmetic formatting & comments only — no logic changes.

const mongoose = require('mongoose');

/**
 * Analysis schema
 * Stores transcript, analytics, and scoring for a user's debate analysis.
 * NOTE: Edits below are non-functional (comments/formatting) to keep behavior identical.
 */
const AnalysisSchema = new mongoose.Schema(
  {
    ...
    // ✅ Fallacy count tracking for analytics (cosmetic formatting only)
    fallacyCount: {
      total: {
        type: Number,
        default: 0,
